...
export type FinicityAccountWithTpUser = {
    tpUserId: string;
} & FinicityAccount;
...
export declare enum TradingPostBrokerageAccountStatus {
    ACTIVE = "ACTIVE",
    INACTIVE = "INACTIVE",
    REMOVED = "REMOVED",
    ERROR = "ERROR",
...
export type SecurityPricesTable = SecurityPrices & {
    id: number;
    created_at: DateTime;
};
...
export declare enum DirectBrokeragesType {
    Robinhood = "Robinhood",
    Ibkr = "Ibkr",
    Finicity = "Finicity"
}
export declare enum BrokerageTaskType {
...
export declare enum BrokerageTaskStatusType {
    Partial = "PARTIAL",
    Pending = "PENDING",
    Running = "RUNNING",
    Failed = "FAILED",
