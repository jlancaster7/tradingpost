import { PhoenixAccount, Position, RefreshResponse, Account, Order, Portfolio, Instrument, RecentDayTrade, OptionOrder, OptionPosition, Dividend, AchTransfer, Sweep, Option } from "./interfaces";
/**
 * TODO:
