...
//AUTH
router.post("/auth/login", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, _c, _d;
...
router.post("/auth/create", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var ex_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
