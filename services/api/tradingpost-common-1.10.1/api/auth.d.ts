...
export declare const forgotPassword: (email: string, callbackUrl: string) => Promise<void>;
export declare const resetPassword: (email: string, tokenOrPass: string, isPass: boolean, newPassword: string) => Promise<{}>;
