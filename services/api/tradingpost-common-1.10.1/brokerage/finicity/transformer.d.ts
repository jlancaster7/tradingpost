...
export declare class Transformer extends BaseTransformer {
    ...
    accounts: (userId: string, finAccounts: FinicityAccount[]) => Promise<number[]>;
    holdings: (userId: string, accountId: string, finHoldings: FinicityHolding[], currency: string | null, accountDetails: CustomerAccountsDetail | null) => Promise<void>;
    ...
    _resolveSecurity: (holding: FinicityHolding, securitiesMap: Map<string, SecurityIssue>, cashSecuritiesMap: Map<string, number>) => Promise<SecurityIssue | undefined>;
