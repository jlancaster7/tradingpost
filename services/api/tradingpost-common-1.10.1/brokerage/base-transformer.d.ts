...
export default class BaseTransformer {
    ...
    upsertAccounts: (accounts: TradingPostBrokerageAccounts[]) => Promise<number[]>;
    ...
    getStartDate: (currentHoldings: TradingPostCurrentHoldings[]) => Promise<DateTime>;
    computeHoldingsHistory: (tpAccountId: number, excludeSecurityTypes?: boolean) => Promise<void>;
