...
export declare const login: (body: Record<string, any>, headers: Record<string, string>) => Promise<any>;
export declare const challengeRequest: (challengeId: string, passCode: string, headers: Record<string, string>) => Promise<any>;
export declare const user: (_accessToken: string) => Promise<RecentDayTrade>;
