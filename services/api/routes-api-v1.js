...
var sharedHandler = function (req, routeDetails) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                reqPath = (0, path_1.join)("../", "entities", "apis", req.params.entity), entity = require(reqPath).default;
...
makeRoute("/authapi/login", function (req) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3: return [4 /*yield*/, loginToken(req.body.pass)];
...
router.get(baseFormat, function (req) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, sharedHandler(req, function (entity) { return __awaiter(void 0, void 0, void 0, function () {
                var id, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
