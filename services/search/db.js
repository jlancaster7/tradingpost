...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const elasticConfiguration = yield configuration.fromSSM("/production/elastic");
    ...
    const ingestSrv = IngestSrv(pgClient, (items) => __awaiter(void 0, void 0, void 0, function* () {
        let group = [];
...
const IngestSrv = (dbClient, ingester) => {
    return {
        twitter: () => __awaiter(void 0, void 0, void 0, function* () {
            let lastId = 0;
            while (true) {
                let query = `SELECT t.tweet_id            AS tweet_id,
                             ...
                             LIMIT 5000;`;
                const response = yield dbClient.query(query);
                ...
                const tweetsAndUsers = response.rows.map((row) => {
                    let obj = {
                        ...
                        text: row.text,
                        tradingPostTweetCreatedAt: luxon_1.DateTime.fromISO(row.trading_post_tweet_created_at),
                        tradingPostTwitterCreatedAt: luxon_1.DateTime.fromISO(row.trading_post_twitter_created_at),
                        tweetID: row.tweet_id,
                        tweetTwitterCreatedAt: luxon_1.DateTime.fromISO(row.tweet_twitter_created_at),
                        tweetURL: row.tweet_url,
                        twitterUserID: row.twitter_user_id,
                        URLs: row.urls,
                        userID: row.trading_post_user_id,
                        userTwitterCreatedAt: luxon_1.DateTime.fromISO(row.user_twitter_created_at)
                    };
                    return obj;
                });
                yield ingester(tweetsAndUsers.map(tw => {
                    let obj = {
                        id: null,
                        content: {
                            body: tw.text,
        ...
        substack: () => __awaiter(void 0, void 0, void 0, function* () {
            let lastId = '';
            while (true) {
                ...
                const substackAndNewsletters = response.rows.map((row) => {
                    let obj = {
                        ...
                        itunes: row.itunes,
                        last_newsletter_build_date: luxon_1.DateTime.fromISO(row.last_newsletter_build_date),
                        link: row.link,
                        ...
                        substack_added_to_tradingpost_date: luxon_1.DateTime.fromISO(row.substack_added_to_tradingpost_date),
                        substack_article_created_at: luxon_1.DateTime.fromISO(row.substack_article_created_at),
                        substack_user_id: row.substack_user_id,
                        title: row.title,
                        tradingpost_substack_article_created_at: luxon_1.DateTime.fromISO(row.tradingpost_substack_article_created_at),
                        tradingpost_user_id: row.tradingpost_user_id
                    };
                    return obj;
                });
                yield ingester(substackAndNewsletters.map(n => {
                    let obj = {
                        id: null,
                        content: {
                            body: n.content,
        ...
        youtube: () => __awaiter(void 0, void 0, void 0, function* () {
            let lastId = '';
            while (true) {
                ...
                const youtubeVideosAndChannel = response.rows.map((row) => {
                    let obj = {
                        ...
                        title: row.title,
                        trading_post_channel_created_at: luxon_1.DateTime.fromISO(row.trading_post_channel_created_at),
                        trading_post_youtube_video_created_at: luxon_1.DateTime.fromISO(row.trading_post_youtube_video_created_at),
                        user_id: row.user_id,
                        video_embed: row.video_embed,
                        video_id: row.video_id,
                        video_url: row.video_url,
                        youtube_channel_id: row.youtube_channel_id,
                        youtube_created_at: luxon_1.DateTime.fromISO(row.youtube_created_at)
                    };
                    return obj;
                });
                yield ingester(youtubeVideosAndChannel.map((yv) => {
                    let obj = {
                        id: null,
                        content: {
                            body: yv.description,
        ...
        spotify: () => __awaiter(void 0, void 0, void 0, function* () {
            let lastId = '';
            while (true) {
                ...
                const spotifyItems = response.rows.map((row) => {
                    let obj = {
                        ...
                        episode_release_date: luxon_1.DateTime.fromISO(row.episode_release_date),
                        ...
                        tradingpost_episode_created_at: luxon_1.DateTime.fromISO(row.tradingpost_episode_created_at),
                        tradingpost_podcast_created_at: luxon_1.DateTime.fromISO(row.tradingpost_podcast_created_at),
                        tradingpost_user_id: row.tradingpost_user_id
                    };
                    return obj;
                });
                yield ingester(spotifyItems.map((si) => {
                    let obj = {
                        id: null,
                        content: {
