...
import {addSecurityPrice, getSecurityBySymbol, Repository} from "../lib/repository";
import {GetQuote, IEX} from "../lib/iex";
...
const start = async () => {
    ...
    const marketService = new MarketService(repository);
