...
const getTradingMap = (client) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield client.query(`SELECT date
    ...
    let tradingDayMap = {};
    let startDate = luxon_1.DateTime.local(2017, 8, 1, 16, 0, 0, 0, { zone: 'America/New_York' });
    let endDate = luxon_1.DateTime.local(2022, 8, 1, 16, 0, 0, 0, { zone: 'America/New_York' });
...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield pgClient.tx((tx) => __awaiter(void 0, void 0, void 0, function* () {
            yield tx.one("UPDATE STATEEM");
            yield tx.none("DELETE STATEMENT");
        }));
    }
    catch (err) {
    ...
    for (const security of securities) {
        ...
        yield repository.upsertSecuritiesPrices(missingTimesInsert);
    }
}))();
