...
export default class Realizefi {
    ...
    createAuthPortal: (userId: string, successRedirect: string, failureRedirect: string, scopes?: AuthPortalScopes[], brokerages?: SupportedBrokerages[]) => Promise<AuthPortalResponse>;
    placeOrder: () => Promise<never>;
    listOrders: (institutionLinkId: string, status?: ListOrdersStatus, cursor?: string, take?: string) => Promise<ListOrdersResponse>;
    getOrder: (institutionLinkId: string, orderId: string) => Promise<GetOrderResponse>;
    listUsersOrders: (userId: string, status?: ListOrdersStatus, cursor?: string, take?: string) => Promise<ListUsersOrdersResponse>;
    listPositions: (institutionLinkId: string) => Promise<ListPositionsResponse>;
    createClientSession: () => Promise<never>;
    getApproximateHistoricalHoldings: (institutionLinkId: string, timeSpan?: TimeSpan) => Promise<GetApproximateHistoricalHoldingsResponse>;
    /**
     ...
     * @param to
     */
    getApproximateHistoricalPerformance: (institutionLinkId: string, interval?: PerformanceInterval, from?: string, to?: string) => Promise<GetApproximateHistoricalPerformanceResponse>;
    ...
    listTransactions: (institutionLinkId: string, cursor?: string, take?: string) => Promise<ListTransactionsResponse>;
