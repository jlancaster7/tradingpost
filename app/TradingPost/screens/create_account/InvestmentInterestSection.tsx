...
import { ModalTopBarProps, Slider, Text, View } from "react-native-ui-lib"
...
import { bindMultiPicker, bindPicker, useReadonlyEntity } from "../../utils/hooks"
...
export function InvestmentInterestSection(props: CreateAccountProps) {
    ...
    return <View><Text>TO BE REIMPLEMENTED</Text></View>
