...
import Svg, { G, SvgProps, Text as SVGText } from 'react-native-svg'
import { Accessor } from './chart/chart'

class XAxis1 extends PureComponent {
    state = {
        width: 0,
        height: 0,
    }
...
export type LinearScale = d3Scale.ScaleLinear<number, number>;
export type XAxisProps<D> = {
    data: D[],
    spacingInner?: number,
    spacingOuter?: number,
    style?: ViewStyle,
...
export function XAxis<D>(props: XAxisProps<D>) {
    // spacingInner: 0.05,
    // spacingOuter: 0.05,
    // contentInset: {},
    // svg: {},
